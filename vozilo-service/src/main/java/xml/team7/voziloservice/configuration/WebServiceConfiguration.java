package xml.team7.voziloservice.configuration;
...
public class WebServiceConfiguration  extends WsConfigurerAdapter {
    ...
    public ServletRegistrationBean messageDispatcherServlet(ApplicationContext applicationContext) {
        ...
        return new ServletRegistrationBean(servlet, "/vozilo-soap/*");
    }
    ...
    @Bean
    public XsdSchema voziloSchema() {
        return new SimpleXsdSchema(new ClassPathResource("Vozilo.xsd"));
    }
