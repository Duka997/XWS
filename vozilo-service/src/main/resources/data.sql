...
insert into `vozilo` (id, br_sjedista_za_djecu, cijena, coliision_damage_wavier, ima_android, kilometraza, moze_precikm, ocjena, klasa_automobila_id, marka_automobila_id, tip_goriva_id, tip_mjenjaca_id, user_id, bundle)
values (1, '4', '1200', false, true, '120000', '150', '5', 1, 1, 3, 1, 3, false);
insert into `vozilo` (id,  br_sjedista_za_djecu, cijena, coliision_damage_wavier, ima_android, kilometraza, moze_precikm, ocjena, klasa_automobila_id, marka_automobila_id, tip_goriva_id, tip_mjenjaca_id, user_id, bundle)
values (2,  '5', '2400', true, true, '150000', '110', '1', 2, 1, 2, 3, 3, false);
insert into `vozilo` (id,  br_sjedista_za_djecu, cijena, coliision_damage_wavier, ima_android, kilometraza, moze_precikm, ocjena, klasa_automobila_id, marka_automobila_id, tip_goriva_id, tip_mjenjaca_id, user_id, bundle)
values (3, '3', '1000', false, false, '220000', '100', '3', 3, 2, 1, 2, 3, false);
insert into `vozilo` (id, br_sjedista_za_djecu, cijena, coliision_damage_wavier, ima_android, kilometraza, moze_precikm, ocjena, klasa_automobila_id, marka_automobila_id, tip_goriva_id, tip_mjenjaca_id, user_id, bundle)
values (4,  '3', '1000', false, false, '515000', '500', '4', 2, 3, 1, 2, 4, false);
insert into `vozilo` (id,  br_sjedista_za_djecu, cijena, coliision_damage_wavier, ima_android, kilometraza, moze_precikm, ocjena, klasa_automobila_id, marka_automobila_id, tip_goriva_id, tip_mjenjaca_id, user_id, bundle)
values (5,  '3', '1000', false, false, '12000', '1100', '2', 1, 3, 2, 1, 4, false);
